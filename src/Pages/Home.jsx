                ...
                <div className=' overflow-auto h-[85vh]  scrollbar-hide'>
                    <div className='h-[20vh] w-[100%] bg-white rounded-3xl flex flex-col justify-evenly items-center'>
                        ...
                        <div className='flex justify-between w-[90%] mx-auto'>
                            ...
                            <div className='flex items-center text-[#b7afa766]  gap-2 '><span className='text-3xl'><HiOutlineEmojiHappy /></span> <span className='text-sm'>Image</span></div>
                        </div>
                    </div>
                    ...
                    <div className='h-[30vh] w-[100%] text-white rounded-3xl bg-[#14f5b2] flex flex-col items-center justify-evenly mt-2'>
                        ...
                        <div className='w-[97%] flex mx-auto gap-3 text-[#67f514]'>
                            {
