            ...
            <div className='flex flex-col gap-3 justify-evenly items-center'>
                {langKnowlodge.map((item,i) => (
                    <div key={i} className='grid grid-cols-4 gap-1 justify-around'>
                        ...
                        {item.Speack ? <div className="flex gap-1 items-center text-xs border px-3  font-semibold border-[#147BF5] rounded-3xl text-[#147BF5] "><span className="text-lg"> <BiSolidUserVoice /></span>Speack</div> : <div></div>}
                        {item.Reading ? <div className="flex gap-1 items-center text-xs border  px-3 font-semibold border-[#147BF5] rounded-3xl text-[#147BF5] "><span className="text-base"><BiSolidBookReader /></span>Read</div> : <div></div>}
                        {item.Writing ? <div className="flex gap-1 items-center text-xs border  px-3 font-semibold border-[#147BF5] rounded-3xl text-[#147BF5] "><span className="text-base"> <BiSolidPencil /></span>Writing</div> : <div></div>}
                    </div>
                ))
